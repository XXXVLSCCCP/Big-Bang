   ...
   <hr>
    ...
    <br>
	<h3>Управление</h3>
    <a href="{{ route('admIndLang') }}">Языки</a><br>
    <a href="{{ route('admIndUser') }}">Пользователи</a><br>
    <a href="{{ route('admIndCountry') }}">Страны</a><br>
    <a href="{{ route('admIndMs') }}">Мессенджеры</a><br>
	<a href="{{ route('adminst') }}">Статусы</a><br>
	<br>
	<a href="{{ route('adminstat') }}">Статистика</a><br>
